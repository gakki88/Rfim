...
b<-MultiPop("VA+(1-exp(-k*t))*(emax*dose/(ED50+dose)-be*VA)",c("VA","k","be","emax","ED50"),c(55,0.005,0.2,30,150),c(0.07,0.5,1,150,0),c(sqrt(28),0),list(c(0,7,seq(28,672,28))),list(c(1,0),c(4,672)),c(2,2,2,1,2),0.99,c(0,25,50,100,150,seq(200,1000,100)),c(1),c(4),0.0001,5000,300)
funFIMem("VA+(1-exp(-k*t))*(emax*dose/(ED50+dose)-be*VA)",c("VA","k","be","emax","ED50"),c(55,0.005,0.2,30,150),c(0.07,0.5,1,150,0),c(sqrt(28),0),list(c(0,168,644,672),c(0,7,644,672),c(0,168,196,672)),c(2,2,2,1,2),c(0,100,1000),c(0.306,0.197,0.497),300)




b<-MultiPop("VA+(1-exp(-k*t))*(emax*dose/(ED50+dose)-be*VA)",c("VA","k","be","emax","ED50"),c(55,0.005,0.2,30,150),c(0.07,0.5,1,150,0),c(sqrt(28),0),list(c(0,7,seq(28,672,28))),list(),c(2,2,2,1,2),0.99,c(0,25,50,100,150,300,500),c(1),c(26),0.0001,5000)


dos<-MultiPop("Emax*t/(t+C50)+S0",c("Emax","C50","S0"),c(30,500,5),c(0.09,0.09,0.09),c(1,0),list(c(0,100 , 300 , 500 , 1000 , 2500 , 5000)),list(),c(2,2,2),0.99,0,c(1),c(3),0.0001,500)
v<- which(dos[[1]]>0.1)
dos[[2]][,v]
plot(dos[[1]],ylim=c(0,1))


pk<-MultiPop("dose/V*ka/(ka-(Cl/V))*(exp(-(Cl/V)*t)-exp(-ka*t))",c("ka","V","Cl"),c(1.6,8,0.13),c(0.7,0.02,0.06),c(0.6,0.07),list(c(0.5, 1, 2, 6, 9, 12, 24, 36, 48, 72, 96, 120)),list(),c(2,2,2),0.99,100,c(1),c(4),0.00001,5000)
...
funFIMem("VA+(1-exp(-k*t))*(emax*dose/(ED50+dose)-be*VA)",c("VA","k","be","emax","ED50"),c(55,0.005,0.2,30,150),c(0.07,0.5,1,150,0),c(sqrt(28),0),list(c(0, 168, 196, 672),c(0, 7, 644, 672),c(0, 7, 644, 672),c(0, 168, 196, 672)),c(2,2,2,1,2),c(0,50,100,500),c(107/300,47/300,14/300,132/300),300)

funFIMem("exp(VA)+(1-exp(-exp(k)*t))*(emax*dose/(exp(ED50)+dose)-exp(be)*exp(VA))",c("VA","k","be","emax","ED50"),c(log(55),log(0.005),log(0.2),30,log(150)),c(0.07,0.5,1,150,0),c(sqrt(28),0),list(c(0, 168, 196, 672),c(0, 7, 644, 672),c(0, 7, 644, 672),c(0, 168, 196, 672)),c(1,1,1,1,1),c(0,50,100,500),c(107/300,47/300,14/300,132/300),300)
