...
b<-MultiPop("VA+(1-exp(-k*t))*(emax*d/(ED50+d)-be*VA)",c("VA","k","be","emax","ED50"),c(55,0.005,0.2,30,150),c(0.07,0.5,1,150,0),c(sqrt(28),0),list(c(0,7,seq(168,672,28))),list(c(1,0),c(4,672)),c(2,2,2,1,2),0.99,c(0,25,50,100,150,300,500),c(1),c(4),0.0001,5000)

b<-MultiPop("VA+(1-exp(-k*t))*(emax*d/(ED50+d)-be*VA)",c("VA","k","be","emax","ED50"),c(55,0.005,0.2,30,150),c(0.07,0.5,1,150,0),c(sqrt(28),0),list(c(0,7,seq(28,672,28))),list(),c(2,2,2,1,2),0.99,c(0,25,50,100,150,300,500),c(1),c(26),0.0001,5000)
...
funFIMem("VA+(1-exp(-k*t))*(emax*dose/(ED50+dose)-be*VA)",c("VA","k","be","emax","ED50"),c(55,0.005,0.2,30,150),c(0.07,0.5,1,150,0),c(sqrt(28),0),b[[3]],c(2,2,2,1,2),b[[4]],c(0.001446944, 0.002661203, 0.01677416, 0.04103269, 0.1407654, 0.3580165, 0.4390931),300)
