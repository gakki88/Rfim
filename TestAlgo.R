...
b<-MultiPop("VA+(1-exp(-k*t))*(emax*d/(ED50+d)-be*VA)",c("VA","k","be","emax","ED50"),c(55,0.005,0.2,30,150),c(0.07,0.5,1,150,0),c(sqrt(28),0),list(c(0, 7, 140, 168, 196, 644, 672)),c(2,2,2,1,2),0.99,c(0,150,500),c(0.25,0.25,0.25),c(4),0.0001,5000)
...
abc<-MultiPop("c+(de-c)/(1+exp(b*log(t)-b*log(a)))",c("c","de","b","a"),c(0,1,1,1),c(0.7,0.02,0.06),c(1,0),list(exp(c(-50:50)/10)),c(2,2,2,2),0.99,100,c(1),c(4),0.0001,500)
...
funFIMem("VA+(1-exp(-k*t))*(emax*dose/(ED50+dose)-be*VA)",c("VA","k","be","emax","ED50"),c(55,0.005,0.2,30,150),c(0.07,0.5,1,150,0),c(sqrt(28),0),
         list(c(0,7,140,672)),c(2,2,2,1,2),c(300),c(0.01,0.01,0.01),300)
...
funFIMem("exp(VA)+(1-exp(-exp(k)*t))*(emax*dose/(exp(ED50)+dose)-exp(be)*exp(VA))",c("VA","k","be","emax","ED50"),c(log(55),log(0.005),log(0.2),30,log(150)),c(0.07,0.5,1,150,0),c(sqrt(28),0),
         list(c(0, 7, 168, 196, 644, 672),c(0, 7, 168, 196, 644, 672),c(0, 7, 168, 196, 644, 672),c(0, 7, 168, 196, 644, 672)),c(1,1,1,1,1),c(0,50,100,500),c(0.25,0.25,0.25,0.25),300)
